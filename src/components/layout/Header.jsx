    ...
    <header className="bg-white/90 dark:bg-dark-background/30 backdrop-blur-md sticky top-0 z-50 border-b border-surface-variant dark:border-white/10 font-roboto">
      ...
      <div className="flex justify-between items-center w-full px-4 md:px-6 py-5 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-2 md:gap-3">
          ...
          <Link to="/calendar" title={t("header.calendar")} className="p-2.5 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full min-h-[50px] min-w-[50px] flex items-center justify-center transition-colors text-gray-500 dark:text-gray-300 shadow-sm bg-white/50 dark:bg-white/5 backdrop-blur-sm">
            <span className="material-symbols-outlined text-[22px]">calendar_month</span>
          </Link>

          <Link to="/stats" title={t("header.statistics")} className="p-2.5 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full min-h-[50px] min-w-[50px] flex items-center justify-center transition-colors text-gray-500 dark:text-gray-300 shadow-sm bg-white/50 dark:bg-white/5 backdrop-blur-sm">
            <span className="material-symbols-outlined text-[22px]">bar_chart</span>
          </Link>

          <Link to="/announcements" title={t("header.announcements")} className="p-2.5 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full min-h-[50px] min-w-[50px] flex items-center justify-center transition-colors text-gray-500 dark:text-gray-300 shadow-sm bg-white/50 dark:bg-white/5 backdrop-blur-sm">
            <span className="material-symbols-outlined text-[22px]">campaign</span>
          </Link>

          <Link to="/files" title={t("header.files")} className="p-2.5 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full min-h-[50px] min-w-[50px] flex items-center justify-center transition-colors text-gray-500 dark:text-gray-300 shadow-sm bg-white/50 dark:bg-white/5 backdrop-blur-sm">
            <span className="material-symbols-outlined text-[22px]">folder</span>
          </Link>

          <Link to="/settings" title={t("header.settings")} className="p-2.5 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full min-h-[50px] min-w-[50px] flex items-center justify-center transition-colors text-gray-500 dark:text-gray-300 shadow-sm bg-white/50 dark:bg-white/5 backdrop-blur-sm">
            <span className="material-symbols-outlined text-[22px]">settings</span>
          </Link>

          <Link to="/admin/programs" title={t("header.programs")} className="p-2.5 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full min-h-[50px] min-w-[50px] flex items-center justify-center transition-colors text-gray-500 dark:text-gray-300 shadow-sm bg-white/50 dark:bg-white/5 backdrop-blur-sm">
            <span className="material-symbols-outlined text-[22px]">admin_panel_settings</span>
          </Link>

          <Link to="/admin/persons" title={t("header.people")} className="p-2.5 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full min-h-[50px] min-w-[50px] flex items-center justify-center transition-colors text-gray-500 dark:text-gray-300 shadow-sm bg-white/50 dark:bg-white/5 backdrop-blur-sm">
            <span className="material-symbols-outlined text-[22px]">group</span>
          </Link>

          <Link to="/admin/leaders" title={t("header.leaders")} className="p-2.5 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full min-h-[50px] min-w-[50px] flex items-center justify-center transition-colors text-gray-500 dark:text-gray-300 shadow-sm bg-white/50 dark:bg-white/5 backdrop-blur-sm">
