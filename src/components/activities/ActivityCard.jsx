...
export default function ActivityCard({ activity, attention = false }) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 mt-1 mb-2">
        <div
