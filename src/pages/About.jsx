...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      "Você pode entrar com o e-mail completo ou apenas com o usuário. Os aliases robin e deivid direcionam para as contas institucionais iracambi@iracambi.com e viveiro@iracambi.com, respectivamente.",
      ...
      "Ao redefinir uma senha, o sistema gera uma senha temporária aleatória, exibida uma única vez ao administrador. Copie-a imediatamente e entregue-a ao usuário por um canal seguro; a troca será exigida no próximo acesso.",
    ],
  },
  {
    id: "navigation",
  ...
  },
  {
    ...
    items: [
      ...
      "As fotos usam caminhos permanentes no armazenamento privado. Ao abrir uma atividade ou relatório, no computador ou celular, o sistema renova automaticamente o acesso, inclusive para links antigos que já tenham expirado. Na geração do PDF, cada imagem selecionada é baixada e incorporada; se uma foto estiver inválida ou indisponível, o sistema informa a falha e não entrega um PDF incompleto.",
  ...
  },
  {
    ...
    items: [
      ...
      "Ao adicionar outra despesa com descrição livre, uma caixa perguntará se ela possui comprovante. Se escolher Sim, a caixa padronizada para anexar o arquivo será disponibilizada no próprio lançamento.",
      ...
      "Use Visualizar para abrir o relatório sem iniciar a impressão. Na visualização, impressão e PDF, a criação registra a assinatura digital do usuário; os aceites de Thaís e Reinaldo registram separadamente nome, data e hora da Gestão Financeira e da Presidência.",
  ...
  },
  {
    ...
    items: [
      ...
      "O reset administrativo remove bloqueios por tentativas incorretas e gera uma senha temporária aleatória. Se o serviço administrativo estiver indisponível, a operação não é executada no navegador e deve ser repetida após a publicação ou recuperação da Edge Function.",
